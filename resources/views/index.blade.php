            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <?php
                                $pathinfo = pathinfo($first_post->featured);
                                $image_name=$pathinfo['filename'].'.'.$pathinfo['extension'];
                            ?>
                            
                            <!-- <img src="{{$first_post->featured}}" alt="seo"> -->
                            <img src="{!! url(Storage::disk('s3')->url('uploads/posts/'.$image_name)) !!}" />
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $node->name}}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($node->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $java->name}}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach($java->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{$post->featured}}" alt="our case">
