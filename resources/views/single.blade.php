	            ...
	            <div class="col-lg-10 col-lg-offset-1">
	                    ...
	                    <div class="post__content">
	                        ...
	                        <div class="post-additional-info">
	                            ...
	                            <span class="category">
	                                ...
	                                <a href="{{ route('category.single',['id'=>$post->id]) }}">{{$post->category->name}}</a>
	                ...
	                <div class="blog-details-author">
	                    ...
	                    <div class="blog-details-author-thumb">
	                        <img src="{{ asset($post->user->profile->avatar) }}" alt="Author" width="90px" height="90px" style="border-radius: 50%">
	                    </div>
